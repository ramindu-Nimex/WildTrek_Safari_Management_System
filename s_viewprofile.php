...
<head>
    ...
    <link rel="stylesheet" href="s_css/s_home2.css">
...
<body>
    ...
    <br> <br> <br> <br> <br> <br>
        ...
        <div class = "card1">
<div class="row">
  <div class="column1"style="background-color:#B0C4DE;">
	...
	if($result->num_rows > 0){
		...
		echo "<span>
                    ...
                    <label>contact No:".$row["contactNo"]." </label><br><br>
						...
						<a href='s_deleteProfile.php?ID=$row[userName]'> <input class='button bttn' type='submit' name='delete' value='Delete' onclick='myFunction()'> </a>	 
